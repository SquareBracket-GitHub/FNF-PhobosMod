...
class FreeplayState extends MusicBeatState
{
	...
	var easyIcon:FlxSprite;
	var normalIcon:FlxSprite;
	var hardIcon:FlxSprite;
	...
	override function create()
	{
		...
		var menuCharacters:Array<String> = [
			'Auditor', 'BF', 'Deimos', 'Gestalt', 'Hank', 'Jeb', 'Phobos', 'Rich', 'Sanford', 'SUS', 'Tricky', 'unfinished Mag'
		];

		var menuCharacter:FlxSprite = new FlxSprite(0, 10);
	...
	override function update(elapsed:Float)
	{
		...
		iconGroup.forEach(function(spr:FlxSprite) {
			if (i == curDifficulty) spr.visible = true;
